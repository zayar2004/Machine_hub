"""Full SQLite → Postgres migration (clear + rewrite) — v2."""
import os
...
def write_remote(data):
    url = Path.home().joinpath("render_db_url.txt").read_text().strip()
    ...
    with app.app_context():
        # Clear
        print("  Clearing old Postgres data...")
...
if __name__ == "__main__":
    ...
    print()
    print("=" * 60)
    print("STEP 2: Clear + Write remote Postgres")
    print("=" * 60)
    write_remote(data)

    print()
    print("✅ Full migration v2 complete")
